...
public class Proteins extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ReadRSS().execute("https://www.petfoodindustry.com/rss/topic/292-proteins");

        lvTitle.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                AlertDialog.Builder mbuider = new AlertDialog.Builder(Proteins.this);
...
//                editText= (TextView) mview.findViewById(R.id.textViewDescription1);
//                editText.setText(arrayDecription1.get(i));
                ...
                buttonMore.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(Proteins.this, NewActivity.class);
...
//                description1 = parser.getValue((element), "p");
//                arrayDecription1.add(description1);
//            }
