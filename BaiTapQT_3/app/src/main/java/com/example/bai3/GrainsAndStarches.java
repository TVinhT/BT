...
public class GrainsAndStarches extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ReadRSS().execute("https://www.petfoodindustry.com/rss/topic/294-grains-and-starches");

        lvTitle.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                AlertDialog.Builder mbuider = new AlertDialog.Builder(GrainsAndStarches.this);
...
//              editText.setText(description1);
                ...
                buttonMore.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Intent intent = new Intent(GrainsAndStarches.this, NewActivity.class);
